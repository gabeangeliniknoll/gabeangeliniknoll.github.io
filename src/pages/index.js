...
const IndexPage = () => (
  <Layout>
    ...
    <p>I am a postdoctoral fellow at the <a href="https://www.math.univ-paris13.fr/laga/index.php/en/">LAGA institute</a> of <a href="https://www.univ-paris13.fr/">Universit<span>&eacute;</span> Sorbonne Paris Nord</a>. This position is funded by the European Union's Horizon 2020 research and innovation programme under the Marie Sk<span>	&#322;</span>odowska-Curie grant agreement No 1010342555. <div style={{marginLeft: `0%`, maxWidth: `3%`, marginBottom: `1rem` }} ><Eusymbol /></div></p>
    ...
    <p>I study interactions between algebraic topology, number theory and geometric topology. Specifically, I am interested invariants of ring spectra, such as algebraic K-theory and Hochschild homology, as well as chromatic, equivariant, and motivic homotopy theory. </p>
    ...
    <h2>Current Events</h2>
      <p>Our <a href="https://aimath.org/programs/squares/">AIM SQuaRE</a> proposal on "Deformations of equviariant homotopy theory" has received funding. Mark Behrens, Eva Belmont, Maxwell Johnson, Hana Kong, and I will meet at AIM to work on our project.</p>
    <h2>Contact</h2>
      <h3>Pronouns:</h3>
        <p>He/Him/His</p>
      <h3>Email:</h3> 
    ...
    <h2>Resources</h2>
      ...
      <h2>Collaborators</h2>
      <p><a href="https://www.math.univ-paris13.fr/~ausoni/">Ch. Ausoni</a>, <a href="https://www3.nd.edu/~mbehren1/">M. Behrens</a>, <a href="https://math.ucsd.edu/~ebelmont/">E. Belmont</a>, <a href="https://dlculver.github.io/">D. L. Culver</a>, <a href="https://users.math.msu.edu/users/teena/Home.html">T. Gerhardt</a>, <a href="https://math.mit.edu/directory/profile.php?pid=2073">J. Hahn</a>, <a href="https://www.math.ucla.edu/~mikehill/">M. Hill</a>, <a href="https://evahoening.netlify.app/">E. H<span>&#246;</span>ning</a>, <a href="https://www.math.ucsd.edu/node/3112">M. Johnson</a>
      <a href="https://hanajiakong.github.io/">H. J. Kong</a>, <a href="https://www.math.upenn.edu/~mmerling/">M. Merling</a>, <a href="https://www.maximilienperoux.com/">M. P<span>&#233;</span>roux</a>, <a href="https://e.math.cornell.edu/people/jdq27/">J.D. Quigley</a>, <a href="https://clasprofiles.wayne.edu/profile/dy8211">A. Salch</a>, <a href="https://www.mn.uio.no/math/personer/vit/rognes/">J. Rognes</a>, <a href="https://people.math.harvard.edu/~dwilson/">D. Wilson</a></p>
    </div>
    </div>
  </Layout>
)
